...
export default {
  ...
  setup() {
    const departments = [
      ...
      { id: 2, brand: Softwar, code: 'SEN', name: 'Software Engineering', info: 'The Software Engineering department focuses on the systematic development and application of techniques for the creation of high-quality software systems. Students learn about software design, development, testing, and maintenance, equipping them with the skills needed in the software industry.' },
      ...
      { id: 4, brand: CYb, code: 'ICT', name: 'Information & Communication, Technology', info: 'The Information and Communication Technology (ICT) Department equips students with skills in programming, networking, software development, and emerging technologies like AI and cybersecurity, fostering innovation and preparing them to design practical solutions for real-world challenges in the digital era.' }
    ];
